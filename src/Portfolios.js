      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <div style={{marginTop:'20px'}}>
            ...
            <Chip variant="outlined" size="small" className="chip-style" label="Restful API"/>        
            <Chip variant="outlined" size="small" className="chip-style" label="SWR"/>        
          </div>
        </CardContent>
      </CardActionArea>
      <CardActions>
      ...
      <CardActionArea>
        <CardContent>
          ...
          <div style={{marginTop:'20px'}}>
            ...
            <Chip variant="outlined" size="small" className="chip-style" label="URQL"/>        
            <Chip variant="outlined" size="small" className="chip-style" label="TYPESCRIPT"/>        
            <Chip variant="outlined" size="small" className="chip-style" label="Back4App"/>   
          </div>          
        </CardContent>
      </CardActionArea>
    ...
    <Card className="thecard">
      <CardActionArea>
        ...
        <CardContent>
          ...
          <div style={{marginTop:'20px'}}>
            <Chip variant="outlined" size="small" className="chip-style" icon={<DiReact style={{fontSize:'20px'}} />} label="React"/>        
            <Chip variant="outlined" size="small" className="chip-style" icon={<FaStripe style={{fontSize:'20px'}} />} label="Stripe"/>        
            <Chip variant="outlined" size="small" className="chip-style" label="Restful API"/>                  
          </div>
        </CardContent>
      </CardActionArea>
    ...
    <Card className="thecard">
      <CardActionArea>
        ...
        <CardContent>
          ...
          <div style={{marginTop:'20px'}}>
            <Chip variant="outlined" size="small" className="chip-style" icon={<DiReact style={{fontSize:'20px'}} />} label="React"/>        
            <Chip variant="outlined" size="small" className="chip-style" label="FACE-API"/>     
            <Chip variant="outlined" size="small" className="chip-style" icon={<DiPhotoshop style={{fontSize:'20px'}} />} label="Photoshop"/>        
          </div>
        </CardContent>
      </CardActionArea>
      <CardActions>
    ...
    <Card className="thecard">
      <CardActionArea>
        ...
        <CardContent>
          ...
          <div style={{marginTop:'20px'}}>
            <Chip variant="outlined" size="small" className="chip-style" icon={<DiReact style={{fontSize:'20px'}} />} label="React"/>
            <Chip variant="outlined" size="small" className="chip-style" icon={<SiRedux style={{fontSize:'20px'}} />} label="Redux"/>
            <Chip variant="outlined" size="small" className="chip-style" icon={<DiFirebase style={{fontSize:'20px'}} />} label="FIREBASE"/>        
          </div>
        </CardContent>
      </CardActionArea>
